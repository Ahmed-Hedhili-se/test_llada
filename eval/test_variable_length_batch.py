...
Until now `src/server.py` could only group requests whose prompts tokenized to
...
from model_update.generate import MASK_ID, generate_cached
from model_update.model import (
    Cfg,
    LLaDAMoEKV,
    build_rope_freqs,
