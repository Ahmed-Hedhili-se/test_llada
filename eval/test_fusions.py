...
def test_rmsnorm():
    from model_update.fused_ops import fused_rmsnorm
    from model_update.model import RMSNorm
...
def test_decode_tail():
    from model_update.fused_ops import fused_decode_tail
...
def test_qkv():
    from model_update.model import FULL_CFG, Attention
...
def test_end_to_end_tokens():
    ...
    import model_update.fused_ops as fo
