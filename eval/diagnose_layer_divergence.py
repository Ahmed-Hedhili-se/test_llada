"""
Layer-by-layer hidden-state divergence trace: model_update vs HF reference,
...
Usage:
    python eval/diagnose_layer_divergence.py --weight-dir ./weights
"""
...
def _find_decoder_layers(model, expected_len):
    ...
    match against model_update's known layer count, preferring the
