...
Takes matched --save-transcripts JSON from a dminfr.engine run and an HF run
...
Usage:
    python archive/investigations/analyze_length_vs_gap.py \\
...
def main():
    ...
    ap.add_argument("--cached", required=True, help="dminfr.engine transcript JSON")
    ...
    print(f"{'response length (chars)':<28} {'n':>5} {'dminfr.engine acc':>18} {'HF acc':>10} {'gap':>8}")
    print("-" * 75)
    for lo, hi in edges:
