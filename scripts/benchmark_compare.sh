...
#    2) Optimized — dminfr/engine/ model, 2 GPUs, Tensor Parallelism
#
#  Usage:
...
#  single-process fallback, dminfr/engine/distributed.py) and the TP
#  torchrun call default to port 29500 for their rendezvous. If something
#  else on the box already holds 29500 (e.g. a running dminfr/serving/server.py
...
BENCH="${ROOT_DIR}/benchmarks/check_time_inference.py"
COMMON_ARGS=(
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  [2/2] OPTIMIZED  (dminfr/engine/, ${NPROC}x GPU, Tensor Parallelism)"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
